...
\begin{figure}[h!]
  \center
  \includegraphics[width = 0.47\textwidth]{error_pr_100bin_rays}
...
\begin{figure}[h!]
  \center
  \includegraphics[width = 0.5\textwidth]{error_pr_100bin_time}
