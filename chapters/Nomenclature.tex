...
\insieme{R}$_\textrm{s}$ &{Regions in source PS related to path $\Pi$}\\
\insieme{R}$_\textrm{t}$ &{Positive luminance regions in target PS related to path $\Pi$}\\
...
$(\Pi_{\variabile{j}})_{\variabile{j}=1, \cdots, \npath}$ &{\variabile{j}-th possible path}\\
