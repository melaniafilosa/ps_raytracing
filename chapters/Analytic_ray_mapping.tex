\chapter{Inverse ray mapping: analytic approach}\label{chap:raymapping1}
...
In this chapter, two different optical systems are investigated here: the two-faceted cup and the so-called multi-faceted cup. Next, the details of the procedure are explained for the two-faceted-cup.
...
We use the same notation of Chapter \ref{chap:PS} indicating with $\mbox{\set{S}{}{}}=\mbox{\set{Q}{}{}}\times\mbox{\set{P}{}{}}$ the PS and with 
...
Given two lines $\lineai$ and $\lineaj$
...
that leave the extremes of line $\lineai$ and hit the interior of line $\lineak$.
...
are explained. 
\subsection{The structure of the inverse ray mapping algorithm}\label{sec:algorithm_raymapping}
...
\end{minipage}\hfill
 ...
 \begin{minipage}[t]{.48\textwidth}
   ...
   \caption{\footnotesize{Target phase space of line $2$. The coordinates of the intersection points between the line $\dir{t,}{$2$} = 0.82$ and $\partial$\set{T}{$2$,}{$1$} are
...
\end{equation}
Extrapolating the QMC error we obtain an approximation of the error between the reference intensity and the exact intensity,
