...
On the other hand, rays that hit points $\point{B}_k$ form vertical lines in target PS \insieme{T} as $\variabile{q} = \textrm{const}$ while varying $\variabile{p}\in[-1,1]$.
\\ \indent 
