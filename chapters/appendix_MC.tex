...
To clarify the connection between MC method and MC ray tracing, in Table \ref{tab:MCcomparison} we report a correspondence of the functions and the variables used here and in chapter \ref{chap:raytracing}.
